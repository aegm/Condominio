 ...
 */
            ...
            foreach($reporte->datos as $registro)
            {
                    $campos = "";
                        ...
                        if($i % 2 == 0)
                             ...
                             //agregando acciones
                         $accion = $html->html("html/accion_tabla.html",array("id"=>$registro['id_torre'],"ROOT_URL"=>ROOT_URL));
    ...
    //$arreglo = array ("slt_filtro"=>array("nombre"=>"id_torre","titulo"));
    $array['FILTRO'] = formulario_html('frm_torres',array("select"=>$arreglo,"tabla"=>"torres"));
    //ADICIONANDO EL FORMULARIO PARA AGREGAR UNA NOTICIA O EDITARLA
    $array['FORMULARIO'] = formulario_html('frm_torres');
